...
internal class AuditRound
{
    ...
    public async Task StartRoundAsync(ulong requestedIn, ulong requestedBy)
    {
    ...
    private async Task ExecuteAudit(AuditRoundRecord auditRound)
    {
        ...
        foreach (var venue in allVenues)
        {
            ...
            if (existingRecord == null)
                await this._venueAuditFactory.CreateAuditFor(venue, auditRound.id, auditRound.RequestedIn, auditRound.RequestedBy).AuditAsync();
